<div id="header">
        ...
        <div class="container">
            <div class="pull-left auto-width-left">
                <ul class="top-menu menu-beta l-inline">
                    <li><a href=""><i class="fa fa-home"></i>my address</a></li>
    ...
    <div class="header-body">
        <div class="container beta-relative">
            <div class="pull-left">
                <a href="index.html" id="logo"><img src="source/assets/dest/images/" width="200px" alt="">Logo</a>
            </div>
    ...
    <div class="header-bottom" style="background-color: #aa1234;">
        <div class="container">
